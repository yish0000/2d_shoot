...
def check_environment_variables_cocos():
    ''' Checking the environment COCOS2D_ROOT, which will be used for building
    '''

    try:
        COCOS2D_ROOT = os.environ['COCOS2D_ROOT'];
    except Exception:
        print "COCOS2D_ROOT not defined. Please define COCOS2D_ROOT in your environment"
...
def build(ndk_build_param,android_platform,build_mode):
    ...
    cocos_root = os.path.join(current_dir, "../../cocos2d-x-3.2")
